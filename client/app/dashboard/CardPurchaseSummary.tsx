...
const CardPurchaseSummary = () => {
  ...
  return (
    <div className="flex flex-col justify-between row-span-2 xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-surface shadow-md rounded-2xl transition-colors duration-300">
      {isLoading ? (
